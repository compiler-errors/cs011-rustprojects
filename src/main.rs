...
fn test_world() {
    ...
    let plane_material = Rc::new(Material::lambertian(Color::new(1.0, 1.0, 1.0)));
    ...
    let sphere2_material = Rc::new(Material::glossy(Color::new(0.7, 1.0, 0.7), 1000.0));
    let sphere3_material = Rc::new(Material::glossy(Color::new(0.3, 0.3, 1.0), 10.0));
